...
int main(int argc, char **argv){
  ...
  window = SDL_CreateWindow("Chip8 Emu", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, WINDOW_WIDTH, WINDOW_HEIGHT, 0);
  if(!window)
  ...
  SDL_UpdateTexture(texture, NULL, display, 4*width);
